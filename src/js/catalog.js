window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/item/item-page-1.jpg', // replace with path to image extracted from catalog layout
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/item/item-page-1.jpg', // replace with image extracted from item layout
    preview: ['img/item/item-page-1.jpg', 'img/item/item-page-2.jpg', 'img/item/item-page-3.jpg'] // replace with paths to images extracted from item layout
}, {
